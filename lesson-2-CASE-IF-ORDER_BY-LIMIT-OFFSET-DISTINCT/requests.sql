...
SELECT id, product_name, standard_cost FROM products ORDER BY standard_cost DESC LIMIT 1;

SELECT id, product_name, standard_cost FROM products ORDER BY standard_cost ASC LIMIT 1;
